...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhấn vào đây để nhận " + (thePercent+899) + " bó hoa";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Thông báo:';
document.querySelector('.Description .modal-body').innerHTML = 'Không có bông hoa nào hết, vì em cũng chính là một bông hoa rồi <i class="fas fa-heart"></i> ';
...
//music 
const musicPlay = document.querySelector("#player");
 
const clickPlayMusic = document.querySelector('.container .sup');

clickPlayMusic.addEventListener("click", () =>{
	musicPlay.play();
})